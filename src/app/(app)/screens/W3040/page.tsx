 ...
 * (docs/conversion/specs/W3040.json 참조 — 재설계 확정사항)
 */
...
export default async function W3040Page({
  searchParams,
}: {
  ...
  return (
    <div>
      ...
      <SearchBar
        ...
        storageKey={`b1w:search:W3040:${user?.uid ?? "anon"}`}
      />
      ...
      {error ? (
        ...
        <>
          ...
          <DataGrid<CustomerSalesRow>
            ...
            storageKey={`b1w:cols:W3040:${user?.uid ?? "anon"}`}
          />
          {rows.length > 0 && (
