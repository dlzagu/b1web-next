 ...
 * 패턴: 조회 목록 화면 복제 (force-dynamic, SearchPanel+SearchField+DataGrid).
 */
  ...
  return (
    <div>
      ...
      <SearchBar
        ...
        storageKey={`b1w:search:stock-movements:${user?.uid ?? "anon"}`}
      />
      ...
      {error ? (
        ...
        <>
          ...
          <DataGrid<InventoryPostRow>
            ...
            storageKey={`b1w:cols:stock-movements:${user?.uid ?? "anon"}`}
          />
          {rows.length > 0 && (
