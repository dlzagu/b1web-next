...
export default async function TransferRequestDetailPage({ params }: { params: Promise<{ docEntry: string }> }) {
  ...
  return (
    <div>
      <div className="mb-4">
        <Link href="/screens/transfer-requests" className={buttonVariants({ variant: "outline", size: "sm" })}>
          ← 목록
        </Link>
      </div>
