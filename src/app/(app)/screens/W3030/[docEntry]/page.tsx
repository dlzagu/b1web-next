/**
 * W3030 매출 조회 상세 — 목록(W3030) 행 클릭 시 드릴다운.
...
export default async function W3030DetailPage({ params }: { params: Promise<{ docEntry: string }> }) {
  ...
  return (
    <div>
      <div className="mb-4">
        <Link href="/screens/W3030" className={buttonVariants({ variant: "outline", size: "sm" })}>
          ← 목록
        </Link>
      </div>
