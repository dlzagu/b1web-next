...
export const MENU: MenuGroup[] = [
  {
    ...
    items: [
      ...
      // 숨김(중복) — 라우트 유지, 메뉴 미노출
      { id: "W3110", label: "품목 마스터 조회", href: "/screens/W3110", ready: true, hidden: true, note: "OITM 재구성(중복 → items 대표)" },
      { id: "W3120", label: "BP 마스터 조회", href: "/screens/W3120", ready: true, hidden: true, note: "OCRD 재구성(중복 → partners 대표)" },
    ],
  },
  {
    id: "sales",
    ...
    items: [
      ...
      // W3030 '판매오더 현황'은 실제 OINV(세금계산서) 조회 — 매출 세금계산서(invoices)와 소스 중복.
      // 사용자 결정(2026-07-10): 메뉴 숨김. 라우트는 유지(추후 '매출 실적 현황'으로 재명명 시 부활 가능).
      { id: "W3030", label: "판매오더 현황", href: "/screens/W3030", ready: true, hidden: true, note: "OINV 기반. 숨김(invoices와 중복) — 2026-07-10 사용자 결정" },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      // 숨김(중복)
      { id: "W3130", label: "창고별 재고수량", href: "/screens/W3130", ready: true, hidden: true, note: "OITW 재구성(중복 → W5070 대표)" },
    ],
  },
  {
    id: "sales-analysis",
    label: "판매 분석",
    items: [
      { id: "W3040", label: "매출처별 판매분석", href: "/screens/W3040", ready: true, note: "거래처 GROUP BY 집계" },
      { id: "W3050", label: "상품별 판매분석", href: "/screens/W3050", ready: true, note: "품목 GROUP BY 집계" },
      { id: "W3060", label: "기간별 판매분석", href: "/screens/W3060", ready: true, note: "월별 집계" },
      { id: "W3070", label: "일일 매출현황", href: "/screens/W3070", ready: true, note: "일자별 집계(CF_W3070 버그 미재현)" },
      { id: "W3080", label: "누적매출추이", href: "/screens/W3080", ready: true, note: "월별 누적" },
      { id: "W3090", label: "거래처별 누적매출", href: "/screens/W3090", ready: true, note: "거래처 GROUP BY" },
      { id: "W3100", label: "일일현황", href: "/screens/W3100", ready: true, note: "일자별 문서 크로스" },
    ],
  },
  {
    id: "system",
