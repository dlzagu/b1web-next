...
- **분석 리포트 W3040~W3100** — 거래처별·품목별·월별·일자별·누계 추이
- **수주 진행 현황 W3071** — 오더→납품→송장 3단계 병렬 집계(거래처별) + 오더라인 진행 상세(진행률·미납·납기경과)
- **재고 W3130 / W5030 / W5060 / W5070 / W5071** — 창고별 재고, 창고 이전 요청, 재고 이동 내역, 재고 입출고 대장(월별·주별 피벗)
